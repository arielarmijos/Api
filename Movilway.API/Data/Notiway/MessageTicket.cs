...
namespace Movilway.API.Data.Notiway
{
    ...
    public partial class MessageTicket
    {
        public MessageTicket()
        {
            this.AuditMessageTicketEntries = new HashSet<AuditMessageTicketEntry>();
        ...
        public virtual ICollection<AuditMessageTicketEntry> AuditMessageTicketEntries { get; set; }
