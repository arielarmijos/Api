...
namespace Movilway.API.Service.ExtendedApi.DataContract
{
    ...
    public class CreateAgentRequest:IMovilwayApiRequestWrapper<CreateAgentRequestBody>
    {
        [MessageBodyMember(Name = "CreateAgentRequest", Namespace = "http://api.movilway.net/schema/extended")]
        public CreateAgentRequestBody Request { set; get; }
    }

    [Loggable]
    [DataContract(Name = "CreateAgentRequest", Namespace = "http://api.movilway.net/schema/extended")]
    public class CreateAgentRequestBody : ASecuredApiRequest
    {
        [Loggable]
