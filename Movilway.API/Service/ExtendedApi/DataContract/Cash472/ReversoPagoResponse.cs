// <copyright file="ReversoPagoResponse.cs" company="Movilway">
...
namespace Movilway.API.Service.ExtendedApi.DataContract.Cash472
{
    ...
    /// reverso de un pago
    /// </summary>
    public class ReversoPagoResponse : AGenericApiResponse
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReversoPagoResponse" /> class.
        /// </summary>
        public ReversoPagoResponse() : base()
        {
