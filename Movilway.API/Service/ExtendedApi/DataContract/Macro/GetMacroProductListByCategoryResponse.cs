...
namespace Movilway.API.Service.ExtendedApi.DataContract.Macro
{
    [DataContract]
    [XmlRoot]
    public class GetMacroProductListByCategoryResponse
    {
        ...
        public GetMacroProductListByCategoryResponse()
        {
            ResponseCode = 99;
        }
    }
    ...
    public class SubCategory
    {
        ...
        public SubCategory()
        {
            MacroProducts = new List<MacroProduct>();
        }
    }
    ...
    public class MacroProduct
    {
        ...
        [DataMember(Name = "rqy", Order = 10, EmitDefaultValue = false, IsRequired = false), XmlElement]
